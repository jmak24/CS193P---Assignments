...
@IBDesignable class SetCardView: UIView {
    ...
    @IBInspectable let cardColor: UIColor = UIColor.clear
    @IBInspectable let cardBorderDefaultWidth: CGFloat = 2.0
    @IBInspectable let cardBorderSelectedWidth: CGFloat = 4.0
    @IBInspectable let cardBorderRadius: CGFloat = 12.0
    @IBInspectable let shapeLineWidth: CGFloat = 4.0
    ...
    init(frame: CGRect, at index: Int, as setCard: SetCard, is cardState: CardState) {
    ...
    override func draw(_ rect: CGRect) {
        ...
        let cardState = self.cardState ?? .normal
        updateBorder(to: cardState)
    }
    
    func updateBorder(to state: CardState) {
        layer.borderWidth = cardBorderDefaultWidth
        ...
        case .selected:
            layer.borderWidth = cardBorderSelectedWidth
